...
//        $myId = Yii::$app->getUser()->id;
    ...
    public function actionNodes()
    {
        ...
        $favoriteNodeCount = $userInfo ? $userInfo->favorite_node_count : 0;
    //      $countQuery = clone $query;
        $pages = new Pagination(['totalCount' => $favoriteNodeCount, 'pageSize' => $this->settings['list_pagesize'], 'pageParam'=>'p']);
    ...
    public function actionTopics()
    {
        ...
        $userInfo = $me->userInfo;
        $favoriteTopicCount = $userInfo ? $userInfo->favorite_topic_count : 0;
    //      $countQuery = clone $query;
        $pages = new Pagination(['totalCount' => $favoriteTopicCount, 'pageSize' => $this->settings['list_pagesize'], 'pageParam'=>'p']);
