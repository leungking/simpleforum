...
<div class="card sf-box">
    <div class="card-header bg-transparent media">
        ...
        <div class="media-body">
            ...
            <h2 class="media-heading"><?php echo SfHtml::uLink($user), '<small>', SfHtml::uGroup($user['score']), '</small>'; ?></h2>
...
<ul class="list-group sf-box sf-box-topics">
    <li class="list-group-item sf-box-header"><?php echo Yii::t('app', '{username}\'s Latest Topics', ['username'=>Html::encode($user['name'])]); ?></li>
<?php
...
?>
    <li class="list-group-item">
        » <?php echo Html::a(Yii::t('app', '{username}\'s All Topics', ['username'=>Html::encode($user['name'])]), ['topics', 'id'=>$user['id']]); ?>
    </li>
</ul>

<ul class="list-group sf-box sf-box-comments">
    <li class="list-group-item sf-box-header">
        <?php echo Yii::t('app', '{username}\'s Latest Comments', ['username'=>Html::encode($user['name'])]); ?>
    </li>
<?php
...
<?php endforeach; ?>
    <li class="list-group-item">
        » <?php echo Html::a(Yii::t('app', '{username}\'s All Comments', ['username'=>Html::encode($user['name'])]), ['comments', 'id'=>$user['id']]); ?>
    </li>
</ul>
